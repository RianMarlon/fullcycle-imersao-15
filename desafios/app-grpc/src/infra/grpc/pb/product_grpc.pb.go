...
func (c *productServiceClient) CreateProduct(ctx context.Context, in *CreateProductRequest, opts ...grpc.CallOption) (*CreateProductResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/protofiles.ProductService/CreateProduct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productServiceClient) FindProducts(ctx context.Context, in *FindProductsRequest, opts ...grpc.CallOption) (*FindProductsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/protofiles.ProductService/FindProducts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProductService_CreateProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protofiles.ProductService/CreateProduct",
	}
...
func _ProductService_FindProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protofiles.ProductService/FindProducts",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protofiles.ProductService",
